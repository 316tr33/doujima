document.addEventListener('DOMContentLoaded', () => {
    ...
    function highlightSearchTerm(item, term) {
        ...
        question.innerHTML = question.dataset.original.replace(regex, '<mark style="background: #d4af37; color: #1a1a1a; padding: 2px;">$1</mark>');
        answer.innerHTML = answer.dataset.original.replace(regex, '<mark style="background: #d4af37; color: #1a1a1a; padding: 2px;">$1</mark>');
    }
